; Benchmark adapted from http://www.lsi.upc.edu/~erodri/webpage/polynomial_invariants/prod4br.htm
...
(define-fun trans-f ((x Int) (y Int) (a Int) (b Int) (p Int) (q Int)
                     (x! Int) (y! Int) (a! Int) (b! Int) (p! Int) (q! Int)) Bool
  (and (not (= a 0)) (not (= b 0)) (= x! x) (= y! y)
       (or (and (= (mod a 2) 0) (= (mod b 2) 0)
                (= q! q)
                (= a! (div a 2)) (= b! (div b 2)) (= p! (* 4 p)))
           (and (= (mod a 2) 1) (= (mod b 2) 0)
                (= p! p) (= b! b)
                (= a! (- a 1)) (= q! (+ q (* b p))))
           (and (= (mod a 2) 0) (= (mod b 2) 1)
                (= p! p) (= a! a)
                (= b! (- b 1)) (= q! (+ q (* a p))))
