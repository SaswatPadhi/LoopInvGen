; Benchmark adapted from http://www.lsi.upc.edu/~erodri/webpage/polynomial_invariants/lcm2.htm
...
(declare-primed-var u Int)
(declare-primed-var v Int)

(define-fun pre-f ((a Int) (b Int) (x Int) (y Int) (u Int) (v Int)) Bool
  (and (> a 0) (> b 0) (= x a) (= y b) (= u b) (= v a)))

(define-fun trans-f ((a Int) (b Int) (x Int) (y Int) (u Int) (v Int)
                     (a! Int) (b! Int) (x! Int) (y! Int) (u! Int) (v! Int)) Bool
    (and (not (= x y)) (= a! a) (= b! b)
         (or (and (> x y) 
                  (= y! y) (= u! u)
                  (= x! (- x y))
