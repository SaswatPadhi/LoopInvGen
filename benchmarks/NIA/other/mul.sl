; Benchmark adapted from Non-linear Loop Invariant Generation using Grobner Bases
...
(define-fun trans-f ((i Int) (s Int) (j Int) (j0 Int)
                     (i! Int) (s! Int) (j! Int) (j0! Int)) Bool
    (and (not (= 0 j))
         (= s! (+ s i))
         (= j! (- j 1))
         (= i! i)
