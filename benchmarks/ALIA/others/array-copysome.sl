...
(declare-primed-var a1 (Array Int Int))
(declare-primed-var a2 (Array Int Int))
...
(define-fun trans_fun ((a1 (Array Int Int)) (a2 (Array Int Int)) (n Int) (i Int) (z Int) (a1! (Array Int Int)) (a2! (Array Int Int)) (n! Int) (i! Int) (z! Int)) Bool
  (and (= i! (+ i 1)) (and (= n! n) (and (= z! z) (and (= a2! a2) (or (and (= i z)(= (select a1! i)(select a1 i))) (and (not(= i z)) (= a1! (store a1 i (select a2 i))))))))))

(define-fun post_fun ((a1 (Array Int Int)) (a2 (Array Int Int)) (n Int) (i Int) (z Int)) Bool
  (or (< i n) (forall ((x Int)) (or (not (not (= x z))) (= (select a1 x) (select a2 x))))))
