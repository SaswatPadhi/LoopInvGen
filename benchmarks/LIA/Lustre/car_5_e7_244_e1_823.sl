...
(define-fun
  ...
  (let
   ...
   (let
    ...
    (let
     ((X3 Bool top.res.abs_6_a_0))
     (let
      ((X4 Int top.res.abs_3_a_0))
      (and
       (= top.usr.OK_a_0 (=> X1 (=> (> X4 9) (not (and X3 X2)))))
       (__node_init_voiture_0
        top.usr.m_a_0
        top.usr.s_a_0
        top.res.abs_0_a_0
...
(define-fun
  ...
  (let
   ...
   (let
    ...
    (let
     ((X3 Bool top.res.abs_6_a_1))
     (let
      ((X4 Int top.res.abs_3_a_1))
      (and
       (= top.usr.OK_a_1 (=> X1 (=> (> X4 9) (not (and X3 X2)))))
       (__node_trans_voiture_0
        top.usr.m_a_1
        top.usr.s_a_1
        top.res.abs_0_a_1
...
(define-fun
  ...
  (let
   ...
   (let
    ...
    (let
     ((X3 Bool top.res.abs_6))
     (let
      ((X4 Int top.res.abs_3))
      (and
       (= top.usr.OK (=> X1 (=> (> X4 9) (not (and X3 X2)))))
       (__node_init_voiture_0
        top.usr.m
        top.usr.s
        top.res.abs_0
