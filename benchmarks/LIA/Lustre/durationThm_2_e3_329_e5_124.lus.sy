...
(define-fun
  __node_init_Age_0 (
    (Age.usr.p_a_0 Bool)
    (Age.usr.age_of_p_a_0 Int)
    (Age.res.init_flag_a_0 Bool)
  ) Bool
...
(define-fun
  __node_trans_Age_0 (
    (Age.usr.p_a_1 Bool)
    (Age.usr.age_of_p_a_1 Int)
    (Age.res.init_flag_a_1 Bool)
    (Age.usr.p_a_0 Bool)
    (Age.usr.age_of_p_a_0 Int)
    (Age.res.init_flag_a_0 Bool)
  ) Bool
  ...
  (and
   (= Age.usr.age_of_p_a_1 (ite Age.usr.p_a_0 (- (- Age.usr.age_of_p_a_0 1) 1) 0))
   (not Age.res.init_flag_a_1))
)
...
(define-fun
  ...
  (and
   (= top.impl.usr.k_a_0 top.usr.k0_a_0)
   (=
    top.res.abs_2_a_0
    (and
     (and
      (>= top.impl.usr.k_a_0 1)
      (=> (>= top.res.abs_0_a_0 top.impl.usr.k_a_0) top.usr.q_a_0))
     (=> (>= top.res.abs_1_a_0 top.impl.usr.k_a_0) top.usr.t_a_0)))
   (let
    ...
    (and
     (=
      ...
      (=>
       X1
       (=>
        (>= top.res.abs_5_a_0 top.impl.usr.k_a_0)
        (and top.usr.q_a_0 top.usr.t_a_0))))
     (= top.res.abs_4_a_0 (and top.usr.p_a_0 top.usr.r_a_0))
     (__node_init_Sofar_0 top.res.abs_2_a_0 top.res.abs_3_a_0 top.res.inst_3_a_0)
     (__node_init_Age_0 top.usr.p_a_0 top.res.abs_0_a_0 top.res.inst_2_a_0)
     (__node_init_Age_0 top.usr.r_a_0 top.res.abs_1_a_0 top.res.inst_1_a_0)
     (__node_init_Age_0 top.res.abs_4_a_0 top.res.abs_5_a_0 top.res.inst_0_a_0)
...
(define-fun
  ...
  (and
   (= top.impl.usr.k_a_1 top.impl.usr.k_a_0)
   (=
    top.res.abs_2_a_1
    (and
     (and
      (>= top.impl.usr.k_a_1 1)
      (=> (>= top.res.abs_0_a_1 top.impl.usr.k_a_1) top.usr.q_a_1))
     (=> (>= top.res.abs_1_a_1 top.impl.usr.k_a_1) top.usr.t_a_1)))
   (let
    ...
    (and
     (=
      ...
      (=>
       X1
       (=>
        (>= top.res.abs_5_a_1 top.impl.usr.k_a_1)
        (and top.usr.q_a_1 top.usr.t_a_1))))
     (= top.res.abs_4_a_1 (and top.usr.p_a_1 top.usr.r_a_1))
     (__node_trans_Sofar_0
      top.res.abs_2_a_1
      top.res.abs_3_a_1
      top.res.inst_3_a_1
...
(define-fun
  ...
  (and
   (= top.impl.usr.k top.usr.k0)
   (=
    top.res.abs_2
    (and
     (and
      (>= top.impl.usr.k 1)
      (=> (>= top.res.abs_0 top.impl.usr.k) top.usr.q))
     (=> (>= top.res.abs_1 top.impl.usr.k) top.usr.t)))
   (let
    ...
    (and
     (=
      ...
      (=>
       X1
       (=> (>= top.res.abs_5 top.impl.usr.k) (and top.usr.q top.usr.t))))
     (= top.res.abs_4 (and top.usr.p top.usr.r))
     (__node_init_Sofar_0 top.res.abs_2 top.res.abs_3 top.res.inst_3)
     (__node_init_Age_0 top.usr.p top.res.abs_0 top.res.inst_2)
     (__node_init_Age_0 top.usr.r top.res.abs_1 top.res.inst_1)
     (__node_init_Age_0 top.res.abs_4 top.res.abs_5 top.res.inst_0)
     top.res.init_flag)))
)
