   ...
   (=
    ...
    (ite
     ...
     (ite
      ...
      (+ (+ voiture.usr.speed_a_0 1) 1)
      voiture.usr.speed_a_0)))
   (= voiture.usr.toofast_a_1 (>= voiture.usr.speed_a_1 3))
   (=
    voiture.usr.time_a_1
    (ite
     voiture.usr.second_a_1
     (+ (+ voiture.usr.time_a_0 1) 1)
     voiture.usr.time_a_0))
   (=
...
(define-fun
  ...
  (and
   (= top.usr.OK_a_0 true)
   (= top.impl.usr.bump_a_0 top.res.abs_2_a_0)
   (let
...
(define-fun
  ...
  (let
   ...
   (and
    (= top.usr.OK_a_1 (=> X1 (not top.impl.usr.bump_a_0)))
    (= top.impl.usr.bump_a_1 top.res.abs_2_a_1)
    (__node_trans_voiture_0
     top.usr.m_a_1
     top.usr.s_a_1
     top.res.abs_0_a_1
...
(declare-primed-var top.impl.usr.bump Bool)
...
(define-fun
  ...
  (and
   (= top.usr.OK true)
   (= top.impl.usr.bump top.res.abs_2)
   (let
...
(define-fun
  ...
  (let
   ((X1 Bool top.res.abs_10!))
   (and
    (= top.usr.OK! (=> X1 (not top.impl.usr.bump)))
    (= top.impl.usr.bump! top.res.abs_2!)
    (__node_trans_voiture_0
     top.usr.m!
     top.usr.s!
